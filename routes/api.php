...
| is assigned the "apii" middleware group. Enjoy building your API!
|
*/
...
Route::post('/v1/catalog/{id}', 'APICatalogController@update')->middleware('auth.basic');

Route::delete('/v1/catalog/{id}', 'APICatalogController@destroy')->middleware('auth.basic');

Route::get('/v1/catalog/{id}/rented', 'APICatalogController@Rented')->middleware('auth.basic');
